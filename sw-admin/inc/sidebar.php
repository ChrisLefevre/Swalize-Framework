...
<?php $ul = $adm->userlogged();
 ...
 <li class="header"><?php echo _("SHOP"); ?> </li>
              ...
              <ul class="treeview-menu">
                ...
                /* Page */ 
	             ...
	             if ($adm->pagemode==1) { ?>
				  ...
				  <li class="header"><?php echo _("PAGES"); ?> </li>
              ...
              <ul class="treeview-menu">
	               <li class="<?php echo ($spages-> lang==$k and $spages->page=='new') ?  'active' : '';  ?>"> <a href="?pages=new&lang=<?php echo $k; ?>" ><i class="material-icons">&#xE89C;</i> <?php echo _("Nouvelle page"); ?> </a></li>
	               <li class="<?php echo ($spages-> lang==$k and $spages->page=='list') ?  'active' : '';  ?>"><a href="?pages=list&lang=<?php echo $k; ?>"><i class="material-icons">&#xE02F;</i> <?php echo _("Les pages"); ?> </a></li>
	              <li class="<?php echo ($spages-> lang==$k and $spages->page=='cats') ?  'active' : '';  ?>"> <a href="?pages=cats&lang=<?php echo $k; ?>" ><i class="material-icons">&#xE8F1;</i> <?php echo _("Templates"); ?> </a></li>  
                            </ul>
            </li>
	               <?php
