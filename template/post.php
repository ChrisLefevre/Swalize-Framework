...
?>
    ...
    <header class="intro-header" style="background-image: url('<?php if(!empty($bpost['cover'])) echo SITE_URL . 'files/show/1600/'.$bpost['cover'];  else echo TEMPLATE_URL.'/img/post-bg.jpg'; ?>')">
        <div class="container">
            <div class="row">
