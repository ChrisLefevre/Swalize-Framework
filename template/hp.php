...
?>
    ...
    <header class="intro-header" style="background-image: url('<?php if(!empty($siteinfo['cover'])) echo SITE_URL . 'files/show/1600/'.$siteinfo['cover'];  else echo TEMPLATE_URL.'/img/home-bg.jpg'; ?>')"">
        <div class="container">
            <div class="row">
